...
def create_necessary_directories():
    monitors_output_dirs = ["bubble_monitor", "coord_monitor", "energy_monitor", "flipping_monitor", "melting_and_fraction_many_monitor",
                            "melting_and_fraction_monitor", "coord_monitor_verbose", "flipping_monitor_verbose"]
